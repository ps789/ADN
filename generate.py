...
if __name__ == "__main__":
    ...
    ckpt = torch.load("checkpoint/conditional_diffusion/conditional_diffusion_330000.pt")
    ...
    if large_batch:
        for i in range(50):
            ...
            np.save(f"eval/conditional_diffusion/conditional_diffusion_samples_{i}.npy", imgs[-1].detach().cpu().numpy())
    else:
